...
import { z } from 'zod'
import { User, Mail, Lock, Loader2, Shield, Clock, CheckCircle } from 'lucide-react'
  ...
  return (
    <VideoBackground>
      <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-md w-full space-y-8 login-card register-ribbon">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-center login-hero-title">Create your account</h2>
            <p className="mt-2 text-center text-sm login-subtitle">Join DocSign — secure signatures, audit logs, and easy collaboration.</p>

            <div className="mt-4 flex justify-center gap-6">
              <div className="flex items-center gap-2 text-sm text-white/80"><Shield className="h-4 w-4" /> Secure</div>
              <div className="flex items-center gap-2 text-sm text-white/80"><Clock className="h-4 w-4" /> Simple</div>
              <div className="flex items-center gap-2 text-sm text-white/80"><CheckCircle className="h-4 w-4" /> Compliant</div>
            </div>

            <p className="mt-3 text-center text-sm login-subtitle">
              Or{' '}
              <Link to="/login" className="font-medium text-white/90 hover:text-white">
